...
- Embeddings are stored as 512-dimensional vectors by default. Override `OPENAI_EMBEDDING_DIMENSIONS` only together with a matching `item_embeddings.embedding` vector dimension migration.
