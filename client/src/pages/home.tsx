    ...
    <Layout>
            ...
            <Card className="h-full min-h-[176px] border-border bg-white shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
              <CardContent className="flex h-full flex-col space-y-4 p-5">
                  <div>
                    ...
                    <h2 className="mt-1.5 text-xl font-bold leading-snug text-foreground">
      ...
      <section className="border-t border-border bg-white py-8">
        <div className="container flex flex-col gap-3 text-sm text-muted-foreground md:flex-row md:items-center md:justify-between xl:max-w-[1440px]">
          <p>
            경찰청 데이터와 사용자 등록 습득물을 한곳에서 확인합니다.
          </p>
          <Link
            href="/report/lost"
